...
ctypes.windll.kernel32.SetConsoleTitleW("Rusticaland Updater - Alpha 1.0.2")
...
def download_and_extract_update(rust_folder, version_number, temp_dir, manifest):
    ...
    # --- přesunout všechny soubory do rust_folder ---
    ...
    for root_dir, dirs, files in os.walk(extract_temp):
        ...
        for file in files:
            ...
            # pokud soubor existuje, smaž ho bez změny vlastnictví
            ...
            # zkopíruj soubor místo přesunu (nezmění vlastníka)
            try:
